...
def pauseScreen( overlaySVG=None ):
    ...
    #screen.fill(BLACK)            #MODIFIQUE para que no se ditorsione la pantalla cuando entra en pausa
    #screen.blit(dimmed, (0,0))    #MODIFIQUE para que no se ditorsione la pantalla cuando entra en pausa

    #group.draw( screen )          #MODIFIQUE para que no aparezca la imagen rara cuando entra en pasua
    return old_screen
